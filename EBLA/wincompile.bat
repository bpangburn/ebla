...
javac -classpath .;./jars/rowset.jar;./jars/pg74.1jdbc3.jar;./jars/jmf.jar;./jars/swingset-bin_0.6.0_beta.jar;./jars/utils.jar com/greatmindsworking/EBLA/Interfaces/EBLAGui.java